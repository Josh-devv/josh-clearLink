        ...
        <main className="w-[100%] h-[100vh] max-md:h-[100%] flex justify-center  items-center max-md:items-start pt-7 max-md:pt-0">
            <div className="w-[90%] max-md:pt-20 flex justify-between  max-md:flex-col">
               <div className="w-[50%] max-lg:w-[90%] max-sm:w-[100%] flex flex-col ">
                <h1 className="text-[4vw] max-sm:text-[25px]  leading-tight font-normal max-md:w-[100%] w-[85%]">Uniting the world, one video call at a time</h1>
                <p className="w-[80%] max-md:w-[100%] pt-4  max-sm:pt-5 max-sm:text-[15px] text-[20px] font-normal text-gray-600">Experience the future of communication with ClearLink – 
                ...
                <div className="flex pt-4">
                    ...
                    <button className=" flex items-center pl-3 text-[13px]"><Image src={AI} className=""/>Discover AI assistant</button>
                </div>
                
                <div className="pt-4 flex max-md:pt-8">
                    <Image src={grp} c/>
                    <div className="pl-3">
                        <span className="flex font-bold text-[12px]"><Image src={star} height={12}/>5.0</span>
          ...
          <div className="w-[100%] max-md:mt-10 max-lg:w-[80%] max-md:w-[100%]  bg-slate-100 shadow-lg py-5 justify-end items-center flex flex-col rounded-md ">
            <Image src={avatar} alt="tyuio" className="w-[90%] max-md:w-[90%]"/>
